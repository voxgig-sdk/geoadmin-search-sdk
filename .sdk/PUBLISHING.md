...
|---|---|---|
| `ts/` | @voxgig-sdk/geoadmin-search-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/geoadmin-search-sdk \
      --repository voxgig-sdk/geoadmin-search-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/geoadmin-search-sdk` shows it, and
`npm trust revoke @voxgig-sdk/geoadmin-search-sdk --id=<id>` removes it.
