...
// GeoadminSearch SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GeoadminSearchOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GeoadminSearchOmni::structfix($now, Struct::undef()))
                        !== json_encode(GeoadminSearchOmni::structfix($val, Struct::undef()))) {
