...
// GeoadminSearch SDK pipeline test
//
...
{
    private static function utility(): GeoadminSearchUtility
    {
        return new GeoadminSearchUtility();
    }
    ...
    private static function ctx(array $over = []): GeoadminSearchContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new GeoadminSearchContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new GeoadminSearchOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof GeoadminSearchError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new GeoadminSearchOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = GeoadminSearchMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new GeoadminSearchOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = GeoadminSearchMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new GeoadminSearchOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = GeoadminSearchMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GeoadminSearchSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = GeoadminSearchMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new GeoadminSearchResponse([]),
            'result' => new GeoadminSearchResult([]),
        ]);
        [, $err] = GeoadminSearchMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec([]),
            'response' => null,
            'result' => new GeoadminSearchResult([]),
        ]);
        [, $err] = GeoadminSearchMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec(['step' => 's']),
            'response' => new GeoadminSearchResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new GeoadminSearchResult([]),
        ]);
        [, $err] = GeoadminSearchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec(['step' => 's']),
            'response' => new GeoadminSearchResponse(self::resp(200, ['v' => 1])),
            'result' => new GeoadminSearchResult([]),
        ]);
        [, $err] = GeoadminSearchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec(['step' => 's']),
            'response' => new GeoadminSearchResponse(self::resp(200, ['v' => 2])),
            'result' => new GeoadminSearchResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        GeoadminSearchMakeResponse::call($ctx);
    ...
    {
        $preset = new GeoadminSearchResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec([]),
            'response' => new GeoadminSearchResponse([]),
            'result' => new GeoadminSearchResult([]),
        ...
        [$got, $err] = GeoadminSearchMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new GeoadminSearchResult([])]);
        [, $err] = GeoadminSearchMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new GeoadminSearchSpec([]), 'result' => null]);
        [, $err] = GeoadminSearchMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GeoadminSearchSpec(['step' => 's']),
            'result' => new GeoadminSearchResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new GeoadminSearchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GeoadminSearchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new GeoadminSearchSpec(['step' => 's']),
            'result' => new GeoadminSearchResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new GeoadminSearchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = GeoadminSearchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new GeoadminSearchResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new GeoadminSearchSpec([]),
            'result' => new GeoadminSearchResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = GeoadminSearchMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GeoadminSearchMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new GeoadminSearchError('boom', 'boom');
        $utility->fetcher = function (GeoadminSearchContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GeoadminSearchSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = GeoadminSearchMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (GeoadminSearchContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = GeoadminSearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(GeoadminSearchResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        GeoadminSearchMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (GeoadminSearchContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new GeoadminSearchSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = GeoadminSearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new GeoadminSearchResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new GeoadminSearchSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = GeoadminSearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = GeoadminSearchMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = GeoadminSearchMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new GeoadminSearchResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, GeoadminSearchDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new GeoadminSearchResult(['ok' => false])]);
        $this->expectException(GeoadminSearchError::class);
        GeoadminSearchDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new GeoadminSearchResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', GeoadminSearchMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        GeoadminSearchMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new GeoadminSearchBaseFeature();
        $b = new GeoadminSearchBaseFeature();
        GeoadminSearchFeatureAdd::call($ctx, $a);
        GeoadminSearchFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): GeoadminSearchBaseFeature
    {
        $f = new GeoadminSearchBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        GeoadminSearchFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): GeoadminSearchContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new GeoadminSearchSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = GeoadminSearchPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        GeoadminSearchPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new GeoadminSearchResponse(['headers' => null]),
            'result' => new GeoadminSearchResult([]),
        ]);
        GeoadminSearchResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        GeoadminSearchResultBody::call($ctx);
