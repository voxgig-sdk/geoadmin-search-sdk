...
// GeoadminSearch SDK utility type

class GeoadminSearchUtility
{
    ...
    public static function copy(GeoadminSearchUtility $src): GeoadminSearchUtility
    {
        $u = new GeoadminSearchUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
