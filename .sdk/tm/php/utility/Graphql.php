...
// GeoadminSearch SDK utility: graphql
//
...
class GeoadminSearchGraphql
{
    ...
    // equivalent.
    public static function body(GeoadminSearchContext $ctx): mixed
    {
    ...
    public static function errors(GeoadminSearchContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
