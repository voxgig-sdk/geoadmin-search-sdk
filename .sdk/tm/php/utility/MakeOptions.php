...
// GeoadminSearch SDK utility: make_options

class GeoadminSearchMakeOptions
{
    ...
    public static function call(GeoadminSearchContext $ctx): array
    {
        ...
        //
        // `GeoadminSearchSchema::optspec()` is built from the model:
        ...
        $optspec = GeoadminSearchSchema::optspec();
