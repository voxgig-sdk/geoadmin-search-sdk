...
// GeoadminSearch SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GeoadminSearchMakeRequest
{
    public static function call(GeoadminSearchContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GeoadminSearchResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GeoadminSearchResponse($fetched);
        } else {
