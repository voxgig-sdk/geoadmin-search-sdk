...
// GeoadminSearch SDK timeout feature
...
class GeoadminSearchTimeoutFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _with_timeout(GeoadminSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GeoadminSearchContext $_ctx, float $ms): void
    {
        $client = $this->client;
