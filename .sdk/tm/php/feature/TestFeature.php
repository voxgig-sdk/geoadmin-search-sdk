...
// GeoadminSearch SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GeoadminSearchTestFeature extends GeoadminSearchBaseFeature
{
    ...
    public function init(GeoadminSearchContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GeoadminSearchContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GeoadminSearchParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GeoadminSearchContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GeoadminSearchContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = GeoadminSearchParam::call($ctx, $k);
