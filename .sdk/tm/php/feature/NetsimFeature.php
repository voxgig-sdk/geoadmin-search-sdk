...
// GeoadminSearch SDK netsim feature
...
class GeoadminSearchNetsimFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _simulate(GeoadminSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GeoadminSearchContext $ctx, array $applied): void
    {
        $client = $this->client;
