...
from projectname_sdk.core.control import GeoadminSearchControl
...
class GeoadminSearchContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = GeoadminSearchControl()
        ...
        if isinstance(sp, GeoadminSearchSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GeoadminSearchResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GeoadminSearchResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return GeoadminSearchOperation({})
    ...
    def make_error(self, code, msg):
        return GeoadminSearchError(code, msg, self)
