...
local GeoadminSearchSDK = {}
GeoadminSearchSDK.__index = GeoadminSearchSDK
...
GeoadminSearchSDK._make_feature = _make_feature


function GeoadminSearchSDK.new(options)
  local self = setmetatable({}, GeoadminSearchSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GeoadminSearchSDK:options_map()
...
function GeoadminSearchSDK:get_utility()
  return Utility.copy(self._utility)
end


function GeoadminSearchSDK:get_root_ctx()
  return self._rootctx
end


function GeoadminSearchSDK:prepare(fetchargs)
...
function GeoadminSearchSDK:direct(fetchargs)
...
-- by passing it.
function GeoadminSearchSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GeoadminSearchSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GeoadminSearchSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function GeoadminSearchSDK:Search(data)
...
function GeoadminSearchSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GeoadminSearchSDK.new(sdkopts)
  sdk.mode = "test"
