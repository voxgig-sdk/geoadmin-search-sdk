...
function runner.env_override(m)
  local live = runner.getenv("GEOADMINSEARCH_TEST_LIVE")
  local override = runner.getenv("GEOADMINSEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GEOADMINSEARCH_TEST_EXPLAIN")
