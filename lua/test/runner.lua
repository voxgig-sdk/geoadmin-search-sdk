...
function runner.env_override(m)
  local live = runner.getenv("GEOADMIN_SEARCH_TEST_LIVE")
  local override = runner.getenv("GEOADMIN_SEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GEOADMIN_SEARCH_TEST_EXPLAIN")
