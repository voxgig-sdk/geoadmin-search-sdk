...
type Args struct {
	Entity string         `json:"entity" jsonschema:"search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GeoadminSearchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "geoadmin-search_list",
		Description: "List records from GeoadminSearch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "geoadmin-search_load",
		Description: "Load a single record from GeoadminSearch. " +
...
func runOp(client *sdk.GeoadminSearchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GeoadminSearchSDK, name string) (sdk.GeoadminSearchEntity, error) {
