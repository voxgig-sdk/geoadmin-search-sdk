// Command GeoadminSearch-mcp is an MCP server exposing the GeoadminSearch
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GeoadminSearch_list  — list records of an entity
//	GeoadminSearch_load  — load a single record of an entity
//
