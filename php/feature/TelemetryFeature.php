...
// GeoadminSearch SDK telemetry feature
...
class GeoadminSearchTelemetryFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _close(GeoadminSearchContext $ctx, bool $ok): void
    {
