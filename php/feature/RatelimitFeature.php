...
// GeoadminSearch SDK ratelimit feature
...
class GeoadminSearchRatelimitFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _acquire(GeoadminSearchContext $ctx): void
    {
    ...
    private function _track(GeoadminSearchContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
