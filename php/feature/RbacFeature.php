...
// GeoadminSearch SDK rbac feature
...
class GeoadminSearchRbacFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _required(GeoadminSearchContext $ctx): ?string
    {
    ...
    private function _reject(GeoadminSearchContext $ctx, string $required): void
    {
    ...
    private function _track(GeoadminSearchContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
