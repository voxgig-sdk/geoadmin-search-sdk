...
// GeoadminSearch SDK clienttrack feature
...
class GeoadminSearchClienttrackFeature extends GeoadminSearchBaseFeature
{
    ...
    public function PostConstruct(GeoadminSearchContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GeoadminSearch-SDK';
