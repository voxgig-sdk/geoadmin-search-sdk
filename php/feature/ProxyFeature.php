...
// GeoadminSearch SDK proxy feature
...
class GeoadminSearchProxyFeature extends GeoadminSearchBaseFeature
{
    ...
    public function init(GeoadminSearchContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GeoadminSearchContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
