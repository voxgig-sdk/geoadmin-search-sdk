...
// GeoadminSearch SDK cache feature
...
class GeoadminSearchCacheFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _through(GeoadminSearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
