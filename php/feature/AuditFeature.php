...
// GeoadminSearch SDK audit feature
...
class GeoadminSearchAuditFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _emit(GeoadminSearchContext $ctx, string $outcome): void
    {
