...
// GeoadminSearch SDK streaming feature
...
class GeoadminSearchStreamingFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _iterate(GeoadminSearchResult $result): \Generator
    {
    ...
    private function _streamable(GeoadminSearchContext $ctx): bool
    {
