...
// GeoadminSearch SDK metrics feature
...
class GeoadminSearchMetricsFeature extends GeoadminSearchBaseFeature
{
    ...
    private function _record(GeoadminSearchContext $ctx, bool $ok): void
    {
