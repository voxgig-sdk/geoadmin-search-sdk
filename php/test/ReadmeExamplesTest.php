...
// GeoadminSearch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GeoadminSearchSDK::test)
...
{
    private const SDK_CLASS = 'GeoadminSearchSDK';
    ...
    private const SDK_BASE = 'geoadminsearch_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../geoadminsearch_sdk.php';
