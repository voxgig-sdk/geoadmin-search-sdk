...
// GeoadminSearch SDK utility: fetcher

class GeoadminSearchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GeoadminSearchSDK/1.0)';
    ...
    public static function call(GeoadminSearchContext $ctx, string $fullurl, array $fetchdef): array
    {
