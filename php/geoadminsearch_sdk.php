...
class GeoadminSearchSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = GeoadminSearchHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = GeoadminSearchHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!GeoadminSearchFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, GeoadminSearchFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return GeoadminSearchUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = GeoadminSearchHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = GeoadminSearchHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = GeoadminSearchHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new GeoadminSearchError($op . "_allow",
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = GeoadminSearchHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new GeoadminSearchError("graphql_error",
                "GeoadminSearchSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new GeoadminSearchSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
