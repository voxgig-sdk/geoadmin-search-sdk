...
from geoadminsearch_sdk.utility import register

# Load features
from geoadminsearch_sdk.feature.base_feature import GeoadminSearchBaseFeature
from geoadminsearch_sdk.features import _has_feature, _make_feature
...
class GeoadminSearchSDK:
    ...
    def get_utility(self):
        return GeoadminSearchUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GeoadminSearchSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from geoadminsearch_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "GeoadminSearchSDK":
        if sdkopts is None:
            sdkopts = {}
