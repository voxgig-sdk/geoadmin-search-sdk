# GeoadminSearch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GeoadminSearchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GeoadminSearchSDK(...) and GeoadminSearchSDK.test(...) become
#      GeoadminSearchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "geoadminsearch_sdk"
_SDK_CLASS = "GeoadminSearchSDK"
