...
function envOverride(m) {
    if ('TRUE' === process.env.GEOADMIN_SEARCH_TEST_LIVE ||
        'TRUE' === process.env.GEOADMIN_SEARCH_TEST_OVERRIDE) {
    ...
    m.GEOADMIN_SEARCH_TEST_EXPLAIN = process.env.GEOADMIN_SEARCH_TEST_EXPLAIN || m.GEOADMIN_SEARCH_TEST_EXPLAIN;
    return m;
}
