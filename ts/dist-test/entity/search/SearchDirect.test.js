...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GeoadminSearchSDK({
    ...
    (0, node_test_1.test)('direct-load-search', async (t) => {
        ...
        const result = await client.direct({
            path: 'rest/services/ech/SearchServer',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.GEOADMIN_SEARCH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GeoadminSearchSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GEOADMIN_SEARCH_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.GeoadminSearchSDK({
        base: 'http://localhost:8080',
