...
func registerSDKWords(r *eng.Registry, client *sdk.GeoadminSearchSDK) {
...
func runOp(client *sdk.GeoadminSearchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
