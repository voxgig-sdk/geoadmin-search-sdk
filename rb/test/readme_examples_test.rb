...
#      offline in seeded test mode (GeoadminSearchSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GeoadminSearch_sdk.rb")
  SDK_CLASS = "GeoadminSearchSDK"
