...
| --- | --- | --- | --- |
| Search | `load` | `GET /rest/services/ech/SearchServer` | See reference |

## Connect to the API

- Production server: `https://api3.geo.admin.ch`
...
- `geoadmin-search_list`: List records for an entity. No active entity supports this operation.
- `geoadmin-search_load`: Load one record for an entity. Supported entities: `search`.
